...
![LeanCloud 管理界面](LeanCloud管理界面.png)
...
![LeanCloud 新建分组](LeanCloud新建分组.png)
...
| SMTP_SERVICE  | QQ                     | [必填]邮件服务提供商，支持 QQ、163、126、Gmail 以及更多
| SMTP_USER     | xxxxxx@qq.com          | [必填]SMTP 登录用户
| SMTP_PASS     | xxxxxxxx               | [必填]SMTP 登录密码（QQ 邮箱需要获取独立密码）
